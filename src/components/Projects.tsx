...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gray-50 parallax-3d">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 parallax-layer">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div key={index} className={`bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200 ${index % 2 === 0 ? 'card-3d' : 'card-3d card-3d-reverse'}`}>
              <div className="p-6">
                  ...
                  <ul className="space-y-1">
                    {project.highlights.map((highlight, idx) => (
                      <li key={idx} className="flex items-start hover-lift">
                        <span className="text-blue-600 mr-2 mt-1 icon-3d">•</span>
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech, idx) => (
                    <span
                      key={idx}
                      className="bg-gray-100 text-gray-700 px-2 py-1 rounded text-xs font-medium skill-tag-3d"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 mb-6 hover-lift">
          ...
          <a
            ...
            className="bg-blue-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200 inline-flex items-center gap-2 btn-3d"
          >
